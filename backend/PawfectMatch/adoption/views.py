...
def adoption_applications(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            cursor.execute("SELECT * FROM AdoptionApp WHERE pet_id = %s AND adopter_id = %s",
        ...
        if row is not None:
            ...
            return Response({'detail': 'User is not an adopter or adoption organization'},
...
class PetsView(APIView):
    ...
    def post(self, request):
        cursor = connection.cursor()
        cursor.execute("SELECT * FROM AdoptionOrganization WHERE ao_id = %s",
        ...
        cursor.execute(
            ...
            [request.data['pet_name'], request.data['pet_size'], request.data['pet_image'], request.data['pet_color'],
...
class BreedsView(APIView):
    ...
    def post(self, request):
        ...
        cursor.execute("INSERT INTO Breed (breed_name, intelligence, playfulness) VALUES (%s, %s, %s)",
                       [request.data['breed_name'], request.data['intelligence'], request.data['playfulness']])
